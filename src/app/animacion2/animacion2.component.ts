...
@Component({
  ...
  styleUrls: ['./animacion2.component.scss'],
  // importacion de animaciones
  changeDetection: ChangeDetectionStrategy.OnPush
  // Termina importacion de animaciones
})
export class Animacion2Component implements AfterViewChecked {
  // importacion de animaciones
  ...
  updateAnimation(): void {
    this.options = {
      path: '/assets/animaciones/fondo.json',
    };
  }

  private createOptions(): void {
    const tranferredAnimationData = this.lottieTransferState.get('/fondo.json');
